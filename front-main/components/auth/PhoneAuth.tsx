...
const PhoneAuth: React.FC<PhoneAuthProps> = ({ mode, onSuccess, onModeChange }) => {
  ...
  const sendOtp = async () => {
    ...
    try {
      ...
      const response = await fetch('/api/v1/phone-auth/send-otp', {
        method: 'POST',
        headers: {
  ...
  const verifyOtp = async () => {
    ...
    try {
      ...
      if (mode === 'login') {
        // Login with phone
        const response = await fetch('/api/v1/phone-auth/login', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
          },
        ...
        // Register with phone
        const response = await fetch('/api/v1/phone-auth/register', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
          },
  ...
  const resendOtp = async () => {
    ...
    try {
      ...
      const response = await fetch('/api/v1/phone-auth/resend-otp', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
